...
public:
  ...
  const sf::Color& Color(size_t i) const
  {
      return m_col[i];
  }

  sf::Color& Color(size_t i)
  {
      return m_col[i];
  }
  ...
  float MinR(size_t i, size_t j) const
  {
      return m_minR[i*m_col.size() + j];
  }

  float& MinR(size_t i, size_t j)
  {
      return m_minR[i*m_col.size() + j];
  }

  float MaxR(size_t i, size_t j) const
  {
      return m_maxR[i*m_col.size() + j];
  }

  float& MaxR(size_t i, size_t j)
  {
      return m_maxR[i*m_col.size() + j];
  }
